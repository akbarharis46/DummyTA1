    ...
    <div class="content">
      ...
      <i class="nav-icon fas fa-home"></i> Dashboard &nbsp; &nbsp; > &nbsp;  &nbsp;<i class="nav-icon fas fa-tablet"></i> Barang&nbsp; > <i class="nav-icon fas fa-pen"></i>Update kategori
            ...
            <div class="form-group">
                                <label for="id_detailproduksi">Nama Stock :</label>
                            ...
                            <div class="form-group">
                                <label for="stock_produksi">Nama Stock :</label>
                                <input type="text" class="form-control" id="stock_produksi" value="<?php echo $rows->stock_produksi; ?>" name="stock_produksi" required  >
                            </div>
