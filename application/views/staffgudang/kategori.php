        ...
        <div class="row">
          <div class="col"> 
            ...
            <div class="card-body" >
                ...
                <a class='btn btn-primary'href="<?php echo site_url(); ?>kategoriclient/post1">
              ...
              <table id="tabel" class="table table-bordered">
                ...
                foreach ($kategori as $rows) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url(); ?>kategoriclient/put1/<?php echo $rows->id_kategori; ?>" class="btn btn-warning">
                            <i class="fa fa-pen" aria-hidden="true"></i></a>
                            <a href="<?= base_url(); ?>kategoriclient/delete1/<?= $rows->id_kategori; ?>" class="btn btn-danger" onClick="return confirm('yakin mau hapus');">
