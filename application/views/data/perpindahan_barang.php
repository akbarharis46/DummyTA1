            ...
            <form action="<?php echo site_url(); ?>pengirimanclient/proses_data_keluar"  class="needs-validation" method="POST" role="form" enctype="multipart/form-data" onload="setSelectBoxByText()">
                 ...
                 <?php foreach ($pengiriman as $rows) : ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nomorhp" value="<?php echo $rows->nama_pengirim; ?>" name="nomorhp" required readonly  >
                            </div>
                            ...
                            <div class="form-group">
                                <label for="tanggal">Tanggal Barang Dikirim :</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" style="margin-left:66px;width:20%;display:inline;" class="form-control form_datetime" id="tanggal_keluar" name="tanggal_keluar" required  >
                            </div>
