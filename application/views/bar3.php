<?php if($this->session->userdata('level')!='staff_pengiriman'){redirect('login');};?>
<style>
    nav-treeview:hover{
        color : #006eff;
    }
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview" >
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url(); ?>produksiclient/index3" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo site_url(); ?>kategoriclient/index3" class="nav-link">
                <i class="fa fa-cube"></i>Data Kategori Barang</a></li>
                </a>
              </li>

              <li class="nav-item">
                <a href="<?php echo site_url(); ?>barangclient/index3" class="nav-link">
