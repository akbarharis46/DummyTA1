        ...
        <div class="row">
          <div class="col"> 
            ...
            <div class="card-body" >
                ...
                <a class='btn btn-primary'href="<?php echo site_url(); ?>stockbarangclient/post/">
              ...
              <table id="tabel" class="table table-bordered">
                ...
                foreach ($stockbarang as $rows) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo site_url(); ?>stockbarangclient/put/<?php echo $rows->id_detailsemuabarang; ?>" class="btn btn-warning">
                            <i class="fa fa-pen" aria-hidden="true"></i></a>
                            <a href="<?= base_url(); ?>stockbarangclient/delete/<?= $rows->id_detailsemuabarang; ?>" class="btn btn-danger" onClick="return confirm('yakin mau hapus');">
